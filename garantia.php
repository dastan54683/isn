...
<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInLeft;">
				...
				<li class="active">Гарантия и возврат</li>
                </ol>
		</div>
    </div>
    <div class="clearfix"> </div>
    <div class="col-md-6 login-left">
				 ...
				 <p>Товар, приобретенный в интернет-магазине IndasExpress, является фирменным и имеет все сопутствующие документы, гарантирующие качество продукции. Товар доставляется с гарантийным талоном, который является документом, обеспечивающим бесплатный ремонт, а также замену запчастей, если в течение гарантийного периода возникнет такая необходимость. В случае возникновения проблем с товаром, которые могут включать возможный производственный брак, необходимо обратиться в сервисный центр. Гарантийный талон дает право на бесплатное сервисное обслуживание в течение указанного периода (в зависимости от условий производителя) с момента осуществления покупки.

В случае, когда сервисный центр не может решить возникшую ситуацию, а также в случае отсутствия сервисного центра в городе, необходимо обратиться к менеджерам интернет-магазина IndasPressExpress. При обращении через электронную почту, укажите в теме письма «Гарантийное обслуживание». 

В случае, если возникшая ситуация не была исправлена дистанционно, товар необходимо отправить по почте. Почтовые услуги оплачиваются покупателем.</p>
			   </div>
               <div class="clearfix"> </div>
			</div>	
		</div>
