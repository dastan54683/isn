		...
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInLeft;">
               ...
               <div class="col-md-6 login-left">
				 ...
				 <p>Услуга курьерской доставки доступна в г. Алматы.
Наш курьер привезет заказ по указанному адресу с в течение суток с момента оплаты заказа. Вы также можете выбрать удобный для вас интервал времени в период:

понедельник - пятница: с 9.00 до 19.00
суббота: с 10.00 до 16.00.
воскресенье – выходной
Курьер дополнительно свяжется с вами перед выездом (приблизительно за 1 час). Если в процессе оформления заказа был выбран способ оплаты «Наличие курьеру», то курьер свяжется с вами после оформления заказа. Стоимость курьерской доставки

в Алматы: 2000 тенге</p>
			   </div>
               <div class="col-md-6 login-left">
			  	 <h4>Доставка через транспортные компании</h4>
				 <p>Если вы территориально находитесь за пределами Алматы и Астаны, то воспользуйтесь услугами доставки через транспортные компании. Мы сотрудничаем со всеми транспортными компаниями в Казахстане.
Отслеживать статус заказа вы сможете на сайте выбранной транспортной компании. Все претензии по поводу поврежденной упаковки или неисправности товара, возникшие в процессе транспортировки, предъявляются выбранной транспортной компании. тоимость доставки в данном случае зависит от региона доставки и веса товара.</p>
			   </div>
               <div class="col-md-6 login-left">
			  	 <h4>Оплата товара в магазине</h4>
				 <p>Вы можете оплатить товар наличными или банковской картой непосредственно в пункте выдачи интернет-магазина по адресу: г. Алматы, ул. Факельная, 5, офис 34</p>
			   </div>
               <div class="clearfix"> </div>
			</div>	
		</div>
